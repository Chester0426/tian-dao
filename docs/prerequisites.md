...
|------|-----|---------|--------|------------|
| [Python 3](https://www.python.org/) + PyYAML | Validates your idea.yaml | [python.org](https://www.python.org/downloads/) then `pip3 install pyyaml` | `python3 --version` | All projects |
...
> The defaults in idea.yaml use Supabase, PostHog, and Vercel. If you change stack values, substitute the corresponding services.
