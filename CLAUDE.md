...
- When asked to do something outside a defined skill (/bootstrap, /change, /deploy, /distribute, /iterate, /retro, /review, /verify), ask the user to clarify before proceeding
