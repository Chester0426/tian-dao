...
- When asked to do something outside a defined skill (/spec, /bootstrap, /change, /deploy, /distribute, /harden, /iterate, /resolve, /retro, /review, /rollback, /teardown, /verify), ask the user to clarify before proceeding
