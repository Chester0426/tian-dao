...
3. **Spec files**
   - Read `idea/experiment.yaml` — extract experiment name, title, target user, primary metric, target value, measurement window
...
1. Read `template_repo` from `idea/experiment.yaml`
